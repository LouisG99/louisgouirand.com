...
int readAndParse(FILE *, char *, char *, char *, char *, char *); int isNumber(char *);
int
...
if (! readAndParse(inFilePtr, label, opcode, arg0, arg1, arg2) ) { /* reached end of file */
}
...
{
char line[MAXLINELENGTH]; char *ptr = line;
/* delete prior values */
